...
const TABS = [
  {
    ...
    items: [
      {
        q: "Как оформить заказ на сайте Love Flowers?",
      ...
      },
      {
        ...
        a: "Розы, тюльпаны, орхидеи, хризантемы, авторские букеты, корзины, коробки с цветами, шары и сладкие дополнения — всё из актуального каталога Love Flowers.",
      },
      {
        q: "Как связаться с Love Flowers?",
